...
posicion Search(arbol_bin *A, elementoa e);
...
elementoa ReadNode(arbol_bin *A, posicion p);
...
void NewRightSon(arbol_bin *A, posicion p, elementoa e);
...
void NewLeftSon(arbol_bin *A, posicion p, elementoa e);
/*recibe<-árbol(A), posición (P), elemento E;
NewLeftSon(A,P,E)
...
void ReplaceNode(arbol_bin *A, posicion p, elementoa e);
/*recibe<-árbol(A), posición (P), elemento (E);
ReplaceNode(A,P)
